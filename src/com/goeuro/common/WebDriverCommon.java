...
public class WebDriverCommon {
	...
	protected static List<WebElement> waitForElements(WebDriver driver,
	...
	protected static boolean waitForElementNotShown(WebDriver driver,
			final By by, int timeout) {
	...
	protected void click(Object obj) {
		logger.info("Clicking an element '" + obj + "' on page '"
		...
		try {
			...
			logger.error("An element '" + obj + "' was not clicked on page '"
					+ driver.getCurrentUrl() + "'");
		}
	}
	...
	protected void type(Object obj, Object text) {
		...
		logger.info("Filling a text '" + text + "' into the field '" + obj
		...
		try {
			...
			logger.error("A text '" + text
					+ "' was not filled in the element '" + obj + "' on page '"
					+ driver.getCurrentUrl() + "'");
		}
	}
	...
	protected void select(Object obj, String text) {
		logger.info("Selecting a value '" + text + "' from select field '"
				+ obj + "' on page '" + driver.getCurrentUrl() + "'");
		WebElement element = getElement(obj);
	...
	protected String getText(Object obj) {
		logger.info("Getting text from element '" + obj + "' on page '"
				+ driver.getCurrentUrl() + "'");
		WebElement element = getElement(obj);
	...
	protected WebElement getElement(Object obj, int timeout) {
		logger.info("Getting element '" + obj + "' on page '"
				+ driver.getCurrentUrl() + "'");
	...
	protected WebElement getElement(By by, int timeout) {
		logger.info("Getting element '" + by + "' on page '"
				+ driver.getCurrentUrl() + "'");
	 ...
	 * @return Boolean
	 */
	protected boolean checkAttribute(Object obj, String attribute,
			Object value, boolean throwError) {
		value = String.valueOf(value);
		logger.info("Verify an attribute '" + attribute + "' equals value '"
				+ value + "' for an object '" + obj + "'");
		...
		if (!(attributeActual.contains((String) value)) && throwError) { // ||
			...
			logger.error("Verify verification of attribute '" + attribute
					+ "' failed. Expected value '" + value + "', actual is '"
					+ attributeActual + "' for an object '" + obj + "'");
			return false;
		}
		logger.info("Verify verification of attribute '" + attribute
				+ "' passed. Expected value '" + value + "', actual is '"
				+ attributeActual + "' for an object '" + obj + "'");
		return true;
	}
